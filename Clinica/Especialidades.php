...
<body id="page-top">
                        ...
                        <div class="card-header py-3">
                            ...
                            <div class="card-body border-bottom-primary">
                                <?php
                                    ...
                                    $resultado = ObtenerEspecialidades();
                                
                                    echo "<table id='especialidades' class='table table-hover' width='100%'>";
                                    ...
                                    if($resultado->num_rows > 0){
                                        ...
                                        while ($row = $resultado->fetch_assoc()) {
                                            ...
                                            echo "<td>{$row['descripcion_puesto']}</td>";
                                            echo "<td><a class='btn btn-sm btn-success' href=\"ModificarEspecialidad.php?id={$row['id_especialidad']}\"><i class='fas fa-pencil-alt'></i></a></td>";
                                            echo "</tr>";
                                        }
                                        echo "</tbody>";
                                    }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var gvregistroTable = $("#especialidades").DataTable({
                "pageLength": 10,
                "ordering": true,
