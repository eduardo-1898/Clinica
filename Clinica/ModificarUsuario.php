                    ...
                    <div class="card mb-3">
                        <div class="card-header py-3">
                            ...
                            <div class="card-body border-bottom-primary">
                                <form action="php/usuarios/updateUsuario.php" method="POST">
                                    <?php

                                        require_once "DAL/usuarios.php";
                                        $resultado = ObtenerUsuariosById($_GET['id']);
                                    ...
                                    <div class="row">
                                        <div class="col col-md-6 col-sm-12">
                                            <a href="Usuarios.php" name="add" class="btn btn-info btn-icon-split">
