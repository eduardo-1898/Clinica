...
<body id="page-top">
                        ...
                        <div class="card-header py-3">
                            ...
                            <div class="card-body border-bottom-primary">
                                <?php
                                    ...
                                    echo "<table id='empleados' class='table table-hover' width='100%'>";
                                    ...
                                    if($resultado->num_rows > 0){
                                        ...
                                        while ($row = $resultado->fetch_assoc()) {
                                            ...
                                            echo "<td><a class='btn btn-sm btn-success' href=\"ModificarEmpleado.php?id={$row['id_empleado']}\"><i class='fas fa-pencil-alt'></i></a></td>";
                                            echo "</tr>";
                                        }
                                        echo "</tbody>";
                                    }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var gvregistroTable = $("#empleados").DataTable({
                "pageLength": 10,
                "ordering": true,
        ...
        if(isset($_SESSION["process"]) && $_SESSION["process"] == "success"){
            echo "<script> Swal.fire({
                icon: 'success',
                title: 'Éxito',
                text: 'Se ha modificado el empleado correctamente',  
                }) </script>'";
            ...
            echo "<script> Swal.fire({
                icon: 'error',
                title: 'Oops...!',
                text: 'No hemos podido modificar el empleado',  
                }) </script>";
                $_SESSION["process"] = null;
        }
    ?>
