...
<body id="page-top">
                        ...
                        <div class="card-header py-3">
                            ...
                            <div class="card-body border-bottom-primary">
                                <?php
                                    ...
                                    echo "<table id='usuarios' class='table table-hover' width='100%'>";
                                    ...
                                    if($resultado->num_rows > 0){
                                        ...
                                        while ($row = $resultado->fetch_assoc()) {
                                            ...
                                            echo "<td><a class='btn btn-sm btn-success' href=\"ModificarUsuario.php?id={$row['id_usuarios']}\"><i class='fas fa-pencil-alt'></i></a></td>";
                                            echo "</tr>";
                                        }
                                        echo "</tbody>";
                                    }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var gvregistroTable = $("#usuarios").DataTable({
                "pageLength": 10,
                "ordering": true,
    ...
    <?php 
        if(isset($_SESSION["process"]) && $_SESSION["process"] == "success"){
            ...
            echo "<script> Swal.fire({
                icon: 'error',
                title: 'Oops...!',
                text: 'No hemos podido ingresar el usuario',  
                }) </script>";
                $_SESSION["process"] = null;
        }
